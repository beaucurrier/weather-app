...
export async function POST(req: NextRequest): Promise<NextResponse> {
  try {
    ...
    const message = {to: email, from: process.env.SEND_FROM_EMAIL as string, subject: 'Verify your email', html: `<p>Click <a href="${verificationLink}">here</a> to verify your email and complete your registration.</p>`}
